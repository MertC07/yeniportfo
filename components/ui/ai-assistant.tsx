...
export function AiAssistant() {
  ...
  const initialWelcomeText = isTr
    ? "Merhaba! Ben Mert Ceren'in yapay zekâ asistanıyım. 🤖\n\nMert'in TEKNOFEST 2026 projesi, yetenekleri, 23 sertifikası veya eğitimi hakkında merak ettiğiniz her şeyi sorabilirsiniz."
    : "Hello! I am Mert Ceren's AI Assistant. 🤖\n\nAsk me anything about Mert's TEKNOFEST 2026 project, skills, certificates, or education!";
